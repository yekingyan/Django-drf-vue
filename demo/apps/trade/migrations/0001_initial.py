# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-02-26 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[set(['成功', 'success']), set(['cancel', '取消']), set(['待支付', 'unpaid'])], max_length=10, verbose_name='订单状态')),
