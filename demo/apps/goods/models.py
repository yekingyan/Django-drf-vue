...
class GoodsCategoryBrand(models.Model):
    category = models.ForeignKey(GoodsCategory, related_name='brands', null=True, blank=True, verbose_name='商品类目', help_text='商品类目')
...
class Goods(models.Model):
    ...
    goods_brief = models.TextField(default='', max_length=500, verbose_name='商品简短描述', help_text='商品简短描述')
...
class IndexAd(models.Model):
    category = models.ForeignKey(GoodsCategory, related_name='indexAd', verbose_name="商品类目", help_text="商品类目")
    goods = models.ForeignKey(Goods, related_name='indexAd', verbose_name='商品', help_text="商品类目")
